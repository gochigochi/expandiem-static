    ...
    return (
        <footer className="bg-custom-alt-black py-16 sm:py32">
            <div className="max-w-screen-2xl mx-auto px-4">
                ...
                <div className="mt-12 pt-8 border-t-[1px] border-slate-100 flex justify-between">
                    <p className="font-thin">Copyright &#169; Expandiem {year} - <span className="font-mono">diegoui</span></p>
                    <div>
